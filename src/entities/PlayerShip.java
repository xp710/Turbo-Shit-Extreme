...
public class PlayerShip extends Ship {
	...
	try {
	    ap = new AudioPlayer("/voice/shoot.wav", false);
	}catch (Exception e){
    ...
    /*
     * Plays upgrade voice line when
     * player gets upgrade.
     * Because the game would do this while the player is respawning as well,
     * it doesn't do it if the player is invincible.
     */
    @Override
